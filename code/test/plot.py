...
csv_floats = []
csv_floats.extend([csv_overall, csv_simpleStructures, csv_getNearCleaners, csv_testNCShortestPaths, csv_gpuCopyR, csv_gpuWork, csv_testNCRest])

csv_detailed_fields = [csv_simpleStructures, csv_getNearCleaners, csv_testNCShortestPaths, csv_gpuCopyR, csv_gpuWork, csv_testNCRest]
