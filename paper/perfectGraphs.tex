...
In 1961 Berge conjured that a graph is perfect if and only if it contains no odd holes and no odd antiholes in what has become known as a strong perfect graph conjecture. In 2001 Chudnovsky et al. have proven it and published the proof in an over 150 pages long paper \citetitle{MC06} \cite{MC06}.
